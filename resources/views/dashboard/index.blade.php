...
<div class="container mb-4" style="background: #201f1f67">
    <div class="container-fluid py-4">
        ...
        <div class="col-lg-8 col-md-6 mb-md-0 mb-4" style="background: #0a0a0ae8">
          <div class="card" style="background: #0a0a0ae8">
            <div class="card-header pb-0" style="background: #0a0a0ae8">
              <div class="row" style="background: #0a0a0ae8">
                ...
                <div class="col-lg-6 col-5 my-auto text-end" style="background: #0a0a0ae8">
                  <div class="dropdown float-lg-end pe-4" style="background: #0a0a0ae8">
                    <a class="cursor-pointer" id="dropdownTable" data-bs-toggle="dropdown" aria-expanded="false">
                      <i class="fa fa-ellipsis-v text-secondary"></i>
                    </a>
                    <ul style="background: #080808bd" class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable">
